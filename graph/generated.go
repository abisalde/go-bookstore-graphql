...
type MutationResolver interface {
	CreateBook(ctx context.Context, input model.BookInput) (*ent.Book, error)
	UpdateBook(ctx context.Context, id string, input model.BookInput) (*ent.Book, error)
	DeleteBook(ctx context.Context, id string) (bool, error)
}
type QueryResolver interface {
	Books(ctx context.Context) ([]*ent.Book, error)
	Book(ctx context.Context, id string) (*ent.Book, error)
}
...
//go:embed "internal/schema/book.graphqls"
...
var sources = []*ast.Source{
	{Name: "internal/schema/book.graphqls", Input: sourceData("internal/schema/book.graphqls"), BuiltIn: false},
}
...
func (ec *executionContext) field_Mutation_createBook_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNBookInput2githubᚗcomᚋabisaldeᚋgoᚑbookstoreᚑgraphqlᚋgraphᚋinternalᚋmodelᚐBookInput(ctx, tmp)
	}
...
func (ec *executionContext) _Book_name(ctx context.Context, field graphql.CollectedField, obj *ent.Book) (ret graphql.Marshaler) {
...
func (ec *executionContext) _Book_publication(ctx context.Context, field graphql.CollectedField, obj *ent.Book) (ret graphql.Marshaler) {
...
func (ec *executionContext) _Mutation_createBook(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*ent.Book)
	fc.Result = res
	return ec.marshalNBook2ᚖgithubᚗcomᚋabisaldeᚋgoᚑbookstoreᚑgraphqlᚋentᚐBook(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_books(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*ent.Book)
	fc.Result = res
	return ec.marshalNBook2ᚕᚖgithubᚗcomᚋabisaldeᚋgoᚑbookstoreᚑgraphqlᚋentᚐBookᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_book(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*ent.Book)
	fc.Result = res
	return ec.marshalOBook2ᚖgithubᚗcomᚋabisaldeᚋgoᚑbookstoreᚑgraphqlᚋentᚐBook(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputBookInput(ctx context.Context, obj any) (model.BookInput, error) {
	...
	fieldsInOrder := [...]string{"name", "author", "publication"}
...
func (ec *executionContext) marshalNBook2githubᚗcomᚋabisaldeᚋgoᚑbookstoreᚑgraphqlᚋentᚐBook(ctx context.Context, sel ast.SelectionSet, v ent.Book) graphql.Marshaler {
	return ec._Book(ctx, sel, &v)
}

func (ec *executionContext) marshalNBook2ᚕᚖgithubᚗcomᚋabisaldeᚋgoᚑbookstoreᚑgraphqlᚋentᚐBookᚄ(ctx context.Context, sel ast.SelectionSet, v []*ent.Book) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNBook2ᚖgithubᚗcomᚋabisaldeᚋgoᚑbookstoreᚑgraphqlᚋentᚐBook(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNBook2ᚖgithubᚗcomᚋabisaldeᚋgoᚑbookstoreᚑgraphqlᚋentᚐBook(ctx context.Context, sel ast.SelectionSet, v *ent.Book) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) unmarshalNBookInput2githubᚗcomᚋabisaldeᚋgoᚑbookstoreᚑgraphqlᚋgraphᚋinternalᚋmodelᚐBookInput(ctx context.Context, v any) (model.BookInput, error) {
...
func (ec *executionContext) marshalOBook2ᚖgithubᚗcomᚋabisaldeᚋgoᚑbookstoreᚑgraphqlᚋentᚐBook(ctx context.Context, sel ast.SelectionSet, v *ent.Book) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Book(ctx, sel, v)
