...
func (bu *BookUpdate) SetPublication(s string) *BookUpdate {
	bu.mutation.SetPublication(s)
	return bu
}

// SetNillablePublication sets the "publication" field if the given value is not nil.
func (bu *BookUpdate) SetNillablePublication(s *string) *BookUpdate {
	if s != nil {
		bu.SetPublication(*s)
	}
	return bu
...
func (bu *BookUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := bu.mutation.Publication(); ok {
		_spec.SetField(book.FieldPublication, field.TypeString, value)
	}
...
// SetPublication sets the "publication" field.
func (buo *BookUpdateOne) SetPublication(s string) *BookUpdateOne {
	buo.mutation.SetPublication(s)
	return buo
}

// SetNillablePublication sets the "publication" field if the given value is not nil.
func (buo *BookUpdateOne) SetNillablePublication(s *string) *BookUpdateOne {
	if s != nil {
		buo.SetPublication(*s)
	}
	return buo
}
...
func (buo *BookUpdateOne) sqlSave(ctx context.Context) (_node *Book, err error) {
	...
	if value, ok := buo.mutation.Publication(); ok {
		_spec.SetField(book.FieldPublication, field.TypeString, value)
	}
